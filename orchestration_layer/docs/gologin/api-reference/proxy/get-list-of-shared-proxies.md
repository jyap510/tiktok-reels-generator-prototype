...
````yaml https://docs-download.gologin.com/openapi.json get /proxy/shared
openapi: 3.0.0
info:
  title: GoLogin
  description: ''
...
paths:
  /proxy/shared:
    get:
      ...
      description: >-
        Gologin allows to share proxies to other users. This endpoint gets all
        shared proxies of the user.
