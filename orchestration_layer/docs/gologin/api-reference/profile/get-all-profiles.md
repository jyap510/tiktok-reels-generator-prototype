...
````yaml https://docs-download.gologin.com/openapi.json get /browser/v2
openapi: 3.0.0
info:
  title: GoLogin
  description: ''
...
paths:
  /browser/v2:
    get:
      ...
      description: >-
        Returns a full list of all user's profiles in all workspaces with
        pagination.
      ...
      parameters:
        ...
        - name: sorterField
          required: false
          in: query
          description: Parameter to sort the results by.
          schema:
            default: createdAt
            enum:
              - lastActivity
        ...
        - name: tag
          required: false
          in: query
          description: Tag ID to filter profiles by. Tag ID can be found in Tags API
          schema:
            type: string
      responses:
        '200':
