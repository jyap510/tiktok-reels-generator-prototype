...
**Arguments**
  ...
  * `pageFunction` [function](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Function> "Function") | [Electron](</docs/api/class-electron> "Electron")#
