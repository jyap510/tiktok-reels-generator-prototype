...
**Arguments**
  ...
  * `options` [Object](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Object> "Object") _(optional)_
    * `time` [number](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type> "Number") | [string](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type> "string") | [Date](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date> "Date") _(optional)_#
...
**Arguments**
  ...
  * `time` [number](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#Number_type> "Number") | [string](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Data_structures#String_type> "string") | [Date](<https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date> "Date")#
